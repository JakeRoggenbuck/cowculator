...
export default function Home() {
	...
	function calculateMethane(): number {
        return cowCount * foodTypes[foodTypeIndex].coef;
    };

	function nextFoodType(): void {
        setFoodTypeIndex((prev) => (prev + 1) % foodTypes.length);
    };

	function prevFoodType(): void {
        setFoodTypeIndex(
            (prev) => (prev - 1 + foodTypes.length) % foodTypes.length,
        );
    };
    ...
    return (
        <div className="min-h-screen bg-[#5fb75f] flex items-center justify-center">
            <div className="text-center text-white p-8">
                ...
                <div className="flex items-center justify-center gap-4 mb-12">
                    ...
                    <div className="text-center">
                        <div className="text-4xl mb-2">
                            {foodTypes[foodTypeIndex].icon}
                        </div>
                        <div className="text-xl font-bold">
                            Food Type: {foodTypes[foodTypeIndex].name}
                        </div>
                    </div>
                ...
                <div className="text-xl font-bold">
                    Methane Produced = {calculateMethane().toLocaleString()}³*
                    (cubic meters³ / day)
                    <br />
